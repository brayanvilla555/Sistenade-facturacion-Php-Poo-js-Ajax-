  ...
  session_start();
   ...
   if (!isset($_SESSION['nombre']))//iniciar la session de logeados
   {
      ...
      if (isset($_SESSION['ventas'])&& $_SESSION['ventas']==1) //iniciamos la concidion para limitar el acceso
     {
		...
		//Obtenemos los datos de la cabecera de la ingreso actual
		require_once "../modelos/Ingreso.php";
		$ingreso= new Ingreso();
		$respuestaIngreso = $ingreso->ingresocabecera($_GET["id"]);
		//Recorremos todos los valores obtenidos
		$regv = $respuestaIngreso->fetch_object();
		...
		//Establecemos las columnas que va a tener la sección donde mostramos los detalles de la ingreso
		...
		//Obtenemos todos los detalles de la ingreso actual
