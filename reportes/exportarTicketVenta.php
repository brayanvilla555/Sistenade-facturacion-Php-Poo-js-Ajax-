...
//Establecemos los datos de la empresa
    ...
    $regtienda = $respuesta->fetch_object();
    $empresa = $regtienda->nombre;
    $ext_logo = "jpg";
    $documento = $regtienda->ruc;
    $direccion = $regtienda->direccion;
    $telefono = $regtienda->telefono;
    $email = $regtienda->email;
...
<table border="0" align="center" width="300px">
    ...
    while ($regd = $rsptad->fetch_object()) {
        ...
        echo "</tr>";
        $cantidad = $cantidad+$regd->cantidad;
    }
    ?>
