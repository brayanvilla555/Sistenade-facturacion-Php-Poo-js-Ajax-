...
<?php if(isset($_SESSION['ventas'])&& $_SESSION['ventas']==1)://iniciamos la concidion para limitar el acceso?>
<!--Contenido-->
                  ...
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Cliente
                            ...
                            <a target="_blanck" href="../reportes/reporteCliente.php"><button class="btn btn-info"><i class="fa fa-file-pdf-o"></i> Reporte</button></a>
                          </h1>
