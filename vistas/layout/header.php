<!--iniciar session siempre y cuando la session no aya estado iniciada-->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            ?>
            <?php endif;?>
            <?php if(isset($_SESSION['consultaComp']) && $_SESSION['consultaComp']==1):?>
            <?=
              '<li class="treeview">
                <a href="#">
            ...
            ?>
            <?php endif;?>
            <?php if($_SESSION['consultaVent']==1):?>
            <?=
              '<li class="treeview">
                <a href="#">
